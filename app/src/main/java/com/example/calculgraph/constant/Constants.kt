...
const val WIDTH_DIALOG_K = 0.9
const val HEIGHT_DIALOG_YES_NO = 0.35
const val HEIGHT_DIALOG_MODE = 0.3
const val HEIGHT_DIALOG_STATISTIC = 0.5
...
val BOUNDS_PLUS_MINUS = Pair(1, 26)
val BOUNDS_MULTIPLICATION_DIVISION = Pair(2, 11)
